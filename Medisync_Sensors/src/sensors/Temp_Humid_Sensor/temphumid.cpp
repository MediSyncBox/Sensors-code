...
TemperatureHumiditySensor::TemperatureHumiditySensor(int dhtPin, int dhtType, int tanknumber) : _dhtPin(dhtPin), _dhtType(dhtType), _dht(dhtPin, dhtType), _tanknumber(tanknumber) {}
